    ...
    public class ReminderConsumerBackgroundService : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                await channel.QueueDeclareAsync("reminder_queue", durable: true, exclusive: false, autoDelete: false);
                ...
                consumer.ReceivedAsync += async (model, ea) =>
                {
                    ...
                    // Standardize time comparison against local system time
                    ...
                    await smtp.SendEmailAsync(msg.Email, $"Reminder: {msg.NoteTitle}", $"Hello,<br/><br/>This is your scheduled reminder for note: <strong>{msg.NoteTitle}</strong> set for {targetTime:g}.");
                };

                await channel.BasicConsumeAsync("reminder_queue", autoAck: true, consumer: consumer, cancellationToken: stoppingToken);
            }
            catch (Exception ex)
            {
