...
namespace LabelManagement.Controllers
{
    [ApiController]
    ...
    public class ReminderController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateReminder([FromBody] CreateReminderDto dto)
        {
            ...
            return Ok(new { success = true, message = "Reminder created and notification queued", data = reminder });
        }

        // GET: api/Reminder/get/{reminderId}
        [HttpGet("get/{reminderId}")]
        ...
        public async Task<IActionResult> GetAllReminders()
        {
            ...
            return Ok(new { success = true, message = "All reminders retrieved successfully", data = reminders });
        }
